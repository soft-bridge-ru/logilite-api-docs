...
### **1.3. Получение данных об успешной загрузке документа**
| Параметр      | Значение                        |
| ------------- | ------------------------------- |
...
4. **Все поля, содержащие `Ссылки/ИД/Guid`, должны быть представлены в формате UUID, используемом в 1С.**